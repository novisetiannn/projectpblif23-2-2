									...
									<table cellpadding="5" style="position: absolute; right: 60px; top: 30px;">
										...
										<td>Weight</td>
											...
											<td>
												...
												foreach ($sementara as  $sm) :
												?>
													<input type="text" name="weight" id="weight" value="<?= $sm->data_sensor2 ?>">
												<?php endforeach; ?>
											</td>
											<td>cm</td>
										</tr>
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p style="color:red;">*If the data is not correct, then wait 10 seconds then press the check button.
						</p>
						</div>
